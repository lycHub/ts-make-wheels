...
var datepicker_datepicker = __webpack_require__(60);
...
// CONCATENATED MODULE: ./src/demos/datepicker/DatePicker/EventEmitter.ts
...
/* harmony default export */ var DatePicker_EventEmitter = (EventEmitter);
...
var DatePicker_DatePicker = /** @class */ (function (_super) {
    ...
    DatePicker.prototype.createMonths = function () {
        this.dateArrs = [];
        var month = this.currentDate.getMonth(); // 5
    ...
    DatePicker.prototype.bindClickEvents = function () {
